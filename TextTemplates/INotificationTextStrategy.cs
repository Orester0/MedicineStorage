...
namespace MedicineStorage.Patterns
{
    ...
    public class MedicineRequiresAuditNotificationStrategy : INotificationTextStrategy
    {
        public string GenerateTitle() => "Medicine Requires Audit";
        public string GenerateMessage(params object[] args) => $"The medicine {args[0]} needs audit.";
    }

    public enum NotificationType
    {
        MedicineAuditReminder,
